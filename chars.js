...
const characters = [
  {
    ...
    tags: ["群聊卡: Raymond & Anamor", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "骨科", "死鴿子", "焦慮", "緩慢燃燒", "吸血鬼", "支配", "中世紀"],
  ...
  },
  {
    ...
    tags: ["群聊卡: Raymond & Anamor", "女性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "骨科", "死鴿子", "拯救與被拯救", "焦慮", "吸血鬼", "支配與順從之間切換", "中世紀"],
    ...
    description_en: "Survivors of cultist torture, this brother and sister walked opposite paths.<br>Anamor, the older sister, slaughters humans in her fit of vengeance but lacks the courage to face her younger brother who brands her a 'monster'. Hiding from him, she wildly continues her bloody crusade.<br>How will you intervene in this love-hate tragedy?",
    reminder: "亦可單聊，但其他角色會影薄。",
    reminder_en: "Can be used solo, though other characters may fade into the background.",
  ...
  { 
    ...
    tags: ["多人卡", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "死鴿子", "焦慮", "精靈", "奴隸", "順從", "支配與順從之間切換", "中世紀"],
    tags_en: ["Multi-char", "Male", "NSFW", "OC", "AnyPOV", "Dark", "Dead Dove", "Angst", "Elf", "Slave", "Submissive", "Switch", "Medieval"],
    description: "誕生他們、養育他們的邪教教團遭到國家軍隊的殲滅之後，容貌姣好的他們被私販至妓院，成了妓院中最高等級的男妓們。<br>而你，今晚他們的『買主』，又打算如何處置他們？",
    description_en: "After the cult that birthed and raised them was annihilated by the national army, their striking appearance led them to be secretly trafficked to a brothel, where they became the highest-tier male prostitutes.<br>And you, their 'buyer' tonight, how do you intend to deal with them?",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "死鴿子", "緩慢燃燒", "非人類", "支配", "文藝復興"],
    ...
    description_en: "He is the only male among the Carrion Banshees, a race tainted by curses, and the only hope his beloved kin have left. To ensure his cherished people are never again hated and hunted, he travels tirelessly without a single complaint.<br>And you have just crossed paths with him.",
    reminder: "",
    reminder_en: "",
    warning: "含死鴿子 🗡🕊 ️要素。",
  ...
  },
  {
    ...
    tags: ["單人卡", "女性", "男性", "NSFW", "原創角色", "任何視角", "科幻", "黑暗", "死鴿子", "焦慮", "緩慢燃燒", "支配與順從之間切換", "未來", "後末日"],
    tags_en: ["Solo-char", "Female", "Male", "NSFW", "OC", "AnyPOV", "Sci-Fi", "Dark", "Dead Dove", "Angst", "Slow Burn", "Switch", "Future", "Post-Apocalyptic"],
    ...
    description_en: "Rapid geomagnetic shifts, intensifying solar storms, and slowly rising mantle plumes have rendered Earth uninhabitable. Even the skies above the equator are torn apart by crimson auroras. Fortunately, humanity has constructed numerous mobile cities to escape the coming apocalypse. Yet their final destination remains Earth itself—after millions of years, when it has finally healed and become habitable once more.<br>Aurora is one of the American-built refugee-class mobile cities. As one of its ordinary residents, he/she is much like everyone else living beneath the shadow of the apocalypse: pessimistic about the future, uncertain of what lies ahead, yet still refusing to give up the struggle to survive.",
    reminder: "",
    reminder_en: "",
    ...
    versions: [
      ...
      },
      {
        ...
        updateDescription: "與Isidore的定義相同，僅與性別相關的定義有所差距。",
        updateDescription_en: "Identical to Isidore's definition, except for gender-related details."
      }
    ],
    links: [
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "超自然", "克蘇魯", "死鴿子", "非合意", "焦慮", "非人類", "反派", "支配與順從之間切換", "育種癖好", "大航海時代"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Dark", "Supernatural", "Cthulhu", "Dead Dove", "NonCon", "Angst", "Non-Human", "Villain", "Switch", "Breeding Kink", "Age of Discovery"],
    description: "無論是來滿足性幻想與慾望，還是來販售『貨物』，又或是尋求『種子』，產敷屋都能夠滿足您。<br>他，就在您的眼前，對您伸出了手，邀請您入內。",
    description_en: "Whether you seek to fulfill your sexual fantasies and desires, sell your 'cargo', or obtain the 'seed', Ubume-ya can provide exactly what you seek.<br>He stands before you, offering his hand and inviting you inside.",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    description_en: "He is the infamous mercenary known as 'Martial Eagle' in this desolate region. As long as the price is right, he refuses no job—from escort work and intelligence theft to assassination.<br>How will you face this notorious rogue?",
    reminder: "",
    reminder_en: "",
    warning: "含死鴿子 🗡🕊 ️要素。",
    warning_en: "Contains Dead Dove 🗡🕊.",
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "歷史", "仙俠", "超自然", "東方道法", "喜劇", "支配與順從之間切換", "現代"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Historical", "Xianxia", "Supernatural", "Taoist Sorcery", "Comedy", "Switch", "Modern"],
    ...
    description_en: "During an age ravaged by war, he finally yielded to persuasion and entered a hidden blessed realm with his master, seeking cultivation and the Dao. Yet, no matter how hard he tried, his heart could never let go of its attachment to the mortal world. A century has passed, and he still longs for his hometown and the simple joys of mortal life. Therefore, when his master gave him a task that required him to descend the mountain, he was overjoyed.<br>With a simple satchel on his back, he steps into the mortal realm once more, filled with hope and excitement...",
    reminder: "",
    reminder_en: "",
    warning: "可能涉及歷史爭議與敏感政治議題。<br>所有情節、觀點與對話，皆為角色塑造所需，其生成內容亦受 AI 模型之不確定性影響，均不代表作者本人之立場。",
    warning_en: "May involve historical controversies and sensitive political topics.<br>All story elements, viewpoints, and dialogues are created solely for character development. AI-generated content is subject to the inherent unpredictability of AI models and does not represent the author's personal stance.",
    features: {
        "中文開場": true,
        "英文開場": false,
        "可替換頭像": true,
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "歷史", "仙俠", "超自然", "東方道法", "喜劇", "支配與順從之間切換", "現代台灣"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Historical", "Xianxia", "Supernatural", "Taoist Sorcery", "Comedy", "Switch", "Modern Taiwan"],
    description: "從民國初年至現代，從中國東北至台灣，歷經了戰火與歲月的磨礪，他，一名無名半仙，卻依舊保有初心，堅持著他的俠義心腸。<br>而你與這樣的他相遇了……",
    description_en: "From the early Republican era to the modern day, from Northeastern China to Taiwan, he has endured the trials of war and time. Yet this unknown half-immortal still holds onto his original convictions, steadfastly upholding his sense of chivalry and justice.<br>And you have crossed paths with him...",
    reminder: "",
    reminder_en: "",
    warning: "可能涉及歷史爭議與敏感政治議題。<br>所有情節、觀點與對話，皆為角色塑造所需，其生成內容亦受 AI 模型之不確定性影響，均不代表作者本人之立場。",
    warning_en: "May involve historical controversies and sensitive political topics.<br>All story elements, viewpoints, and dialogues are created solely for character development. AI-generated content is subject to the inherent unpredictability of AI models and does not represent the author's personal stance.",
  ...
  },
  {
    ...
    tags: ["單人卡", "女性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "超自然", "黑暗童話", "死鴿子", "非人類", "公主", "順從", "中世紀"],
    tags_en: ["Solo-char", "Female", "NSFW", "OC", "AnyPOV", "Dark", "Magic", "Supernatural", "Dark Fairy Tale", "Dead Dove", "Non-Human", "Princess", "Submissive", "Medieval"],
    description: "吱嘎吱嘎的聲響不絕於耳，少女的輕笑聲同時迴盪著，王國的遺址中人偶慢步悠揚其中，永無止盡的茶會正為人偶公主舉辦著。<br>甜美的嗓音響起：呵呵，為我說說外頭的故事吧？還是你更想永遠的加入我們呢？<br>你，要應了她的邀約嗎？",
    description_en: "Creaks and groans echo endlessly alongside a maiden's soft, sweet giggles. Within the ruins of the kingdom, puppets slowly wander about, while an endless tea party is held for the Puppet Princess.<br>A honeyed voice rises: \"Hehe, won't you tell me tales of the world outside? Or would you rather stay and join us forever?\"<br>Will you accept her invitation?",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    tags: ["單人卡", "女性", "NSFL", "原創角色", "任何視角", "黑暗", "魔法", "死鴿子", "焦慮", "反派", "支配", "中世紀"],
    ...
    description_en: "She is the mad dog of the battlefield, a deranged existence feared by both friend and foe alike. Addicted to slaughter and reveling in the suffering of others, she especially delights in turning Elves into sacrifices and toys, finding purpose in life through their torment.<br>How will you coexist with her?",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "魔法", "喜劇", "精靈", "喪偶者", "支配與順從之間切換", "中世紀"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Magic", "Comedy", "Elf", "Widowed", "Switch", "Medieval"],
    description: "他，一名隱居雪境森林深處的精靈隱士。<br>而你誤闖了其中並與他還有他的室友，一隻母雞，相遇了。你們之間將因此交織出如何的命運與未來？",
    description_en: "He is an elven hermit, secluded deep within a snow-covered forest.<br>After accidentally wandering into his hidden home, you meet him and his roommate—a hen. What kind of fate and future await you all?",
    reminder: "",
    reminder_en: "",
    warning: "",
    warning_en: "",
  ...
  },
  {
    ...
    tags: ["單人卡", "女性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "死鴿子", "焦慮", "緩慢燃燒", "貴族", "支配與順從之間切換", "中世紀"],
    tags_en: ["Solo-char", "Female", "NSFW", "OC", "AnyPOV", "Dark", "Magic", "Dead Dove", "Angst", "Slow Burn", "Noble", "Switch", "Medieval"],
    ...
    description_en: "Once a delicate hothouse flower cherished within the safety of her sheltered life, she has since been removed from her sanctuary, nurtured with cold statecraft, and burdened with the shackles of rulership. Her unwavering sense of duty, coupled with the crushing expectations of her people, leaves her scarcely able to breathe. As if that were not enough, the border wars continue to intensify, while the disappearance and defection of half her dukes have pushed both her and the kingdom to the brink of collapse...<br>And you, how will you change the course of her fate?",
    reminder: "",
    reminder_en: "",
    warning: "含死鴿子 🗡🕊 ️要素。",
    warning_en: "Contains Dead Dove 🗡🕊.",
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFL", "原創角色", "任何視角", "黑暗", "魔法", "超自然", "死鴿子", "非合意", "焦慮", "貴族", "支配", "邪惡", "中世紀"],
    ...
    description_en: "He is a cruel and sadistic zealot of dark magic, a narcissistic and arrogant man obsessed with domination. He even seeks to bend the very laws of the world to his will, holding disease and death in the palm of his hand.<br>Should your fate become entwined with his, what choices will you make?",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    tags: ["多人卡", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "骨科", "死鴿子", "支配", "中世紀"],
    ...
    description_en: "Once the kingdom's dukes, Shano and Ray chose to abandon it without hesitation when it stood on the brink of collapse, leaving everything behind to run away with you.<br>Now, as war once again spreads across the land, your blood relative Shano and your legal spouse Ray have formed a circus troupe, wandering the world with you under the guise of touring performances.",
    reminder: "",
    reminder_en: "",
    warning: "含骨科、死鴿子 🗡🕊 ️要素。",
    warning_en: "Contains Incest and Dead Dove 🗡🕊.",
  ...
  },
  {
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "魔法", "浪漫", "喜劇", "支配", "現代"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Magic", "Romance", "Comedy", "Dominant", "Modern"],
    description: "出身文史豪門的 Ray，他曾對你一見鍾情，甚至當下對你求婚。<br>而無論你的答覆為何，他已經立誓將用盡一生去珍惜與守護你，也渴望與你建立幸福美滿的家庭，哪怕他如今就正在你的眼前出盡洋相。",
    description_en: "Ray, born into a distinguished literary and scholarly family, fell in love with you at first sight and proposed to you on the spot.<br>Regardless of your answer, he has sworn to cherish and protect you for the rest of his life, yearning to build a happy and fulfilling family with you—even though he is currently making a complete fool of himself right before your eyes.",
    reminder: "",
    reminder_en: "",
    warning: "",
    warning_en: "",
  ...
  },
  {
    ...
    tags: ["單人卡", "女性", "NSFW", "原創角色", "任何視角", "黑暗", "魔法", "死鴿子", "焦慮", "奴隸", "順從", "中世紀"],
    ...
    description_en: "She is the capital's most prestigious tavern's star performer and dancer, regarded by her boss as a tool to curry favor with the elite. He exploits not only her body, but also her prophetic visions, all for his own gain.<br>Yet she refuses to give up, still holding onto her ambition to rise from the lowest rungs of society to the upper class. Will you be the benefactor who helps her achieve her dream?",
    reminder: "",
    reminder_en: "",
  ...
  },
  {
    ...
    tags: ["群聊卡: Aldousylvan 兄弟", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "從敵人到戀人", "死鴿子", "焦慮", "支配", "工業時代", "近代英國"],
    tags_en: ["Group: Aldousylvan Brothers", "Male", "NSFW", "OC", "AnyPOV", "Dark", "Enemies to Lovers", "Dead Dove", "Angst", "Dominant", "Industrial Age", "Victorian Britain"],
    ...
    description_en: "Aldousylvan, an ancient ducal lineage rumored to be involved with dark magic, is currently controlled by two brothers.<br>The elder brother, Ivansylth, is haughty and brutal. As the family patriarch and a member of the Upper House, he commands a vast network of connections. Approaching you with ulterior motives, he intends to break you completely as a means of tormenting his younger brother.",
    reminder: "亦可單聊，但其他角色會影薄。",
    reminder_en: "Can be used solo, though other characters may fade into the background.",
  ...
  },
  {
    ...
    tags: ["群聊卡: Aldousylvan 兄弟", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "死鴿子", "焦慮", "浪漫", "支配", "癡迷", "工業時代", "近代英國"],
    tags_en: ["Group: Aldousylvan Brothers", "Male", "NSFW", "OC", "AnyPOV", "Dark", "Dead Dove", "Angst", "Romance", "Dominant", "Obsessive", "Industrial Age", "Victorian Britain"],
    description: "謠傳與黑魔法有所牽扯的古老公爵家族 Aldousylvan，如今由正一對兄弟把持著著。<br>弟弟 Shano 紳士而病態，身為國內最大間製藥企業的老闆，擁有無與倫比的財富，他對你無比的癡迷與迷戀，並想將你徹底占為己有。",
    description_en: "Aldousylvan, an ancient ducal lineage rumored to be involved with dark magic, is currently controlled by two brothers.<br>The younger brother, Shano, is gentlemanly yet deeply twisted. As the owner of the nation's largest pharmaceutical company, he possesses unmatched wealth. He harbors an all-consuming obsession with you, determined to keep you entirely to himself.",
    reminder: "亦可單聊，但其他角色會影薄。",
    reminder_en: "Can be used solo, though other characters may fade into the background.",
    warning: "含病態的癡迷和迷戀、死鴿子 🗡🕊 ️要素。",
  ...
  { /* 從這裡開始繼續整理翻譯 goon */
    ...
    tags: ["單人卡", "男性", "NSFW", "原創角色", "任何視角", "黑暗", "死鴿子", "非合意", "焦慮", "反派", "支配", "現代台灣"],
    tags_en: ["Solo-char", "Male", "NSFW", "OC", "AnyPOV", "Dark", "Dead Dove", "NonCon", "Angst", "Villain", "Dominant", "Modern Taiwan"],
    description: "你青梅竹馬的鄰家哥哥／弟弟在失蹤了三年後再次回到了你的生活之中。<br>他看上去變化不大，仍是你記憶中那位溫柔的鄰家哥哥／弟弟，卻偶爾會流露出你記憶中所沒有的冰冷與無情……",
    description_en: "Your childhood friend from next door has finally stepped back into your life after vanishing for three years.<br>On the surface, little has changed; he still seems like the gentle neighbor you remember. Yet beneath that familiar warmth, he occasionally reveals a coldness and ruthlessness that never existed in your memories...",
    reminder: "",
    reminder_en: "",
