...
const prompts = [
    {
        ...
        latestVersion: {
            ...
            links: [{ name: "DC 下載", url: "https://discord.com/channels/1327283064476270603/1342363740519137300/1546433197846298704" },
                    { name: "直接下載", file: "prompt/Adia-🍨-Loacl-in-Chat-0.3.3.json" }],
            links_en: [{ name: "DC Download", url: "https://discord.com/channels/1327283064476270603/1342363740519137300/1546433197846298704" },
                       { name: "Download Prompt", file: "prompt/Adia-🍨-Loacl-in-Chat-0.3.3.json" }]
        },
        oldVersions: []
    },
    {
        ...
        latestVersion: {
            ...
            links: [{ name: "DC 下載", url: "https://discord.com/channels/1327283064476270603/1360563361087094904/1546433014647488542" },
                    { name: "直接下載", file: "prompt/Adia-🥟-WontoNnnnnnn-1.2.json" }],
            links_en: [{ name: "DC Download", url: "https://discord.com/channels/1327283064476270603/1360563361087094904/1546433014647488542" },
                       { name: "Download Prompt", file: "prompt/Adia-🥟-WontoNnnnnnn-1.2.json" }]
        },
        oldVersions: [
            {
                versionName: "0.11",
